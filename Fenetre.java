...
private RoutVerticale r1=new RoutVerticale(1,"1");
private RouteHorizontale r2=new RouteHorizontale(2,"2");
...
private void go(){
  ...
  // f1.changeColor();	
    Vehicules v1= new Vehicules(50,Color.yellow,5,10,400);
    Vehicules v3= new Vehicules(50,Color.green,10,10,300);
    Vehicules v4= new Vehicules(50,Color.yellow,15,400,300);
    Vehicules v2= new Vehicules(50,Color.red,5,500,10);
